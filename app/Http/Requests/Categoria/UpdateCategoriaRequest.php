...
/**
 * Request para validar la actualización de una Categoría.
 * 
 * Validaciones:
 * - El nombre no puede estar duplicado dentro de la misma categoría global (excluyendo el registro actual)
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'nombre' => [
                ...
                // Validación unique compuesta excluyendo el registro actual
