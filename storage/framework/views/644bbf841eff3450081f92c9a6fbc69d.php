                            ...
                            <div class="input-group flex-nowrap">
                                <select id="proveedor_id" name="proveedor_id" class="form-select select2-basic" required>
                                    ...
                                    <?php $__currentLoopData = $proveedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proveedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($proveedor->id); ?>"><?php echo e($proveedor->nombre); ?>

                                            (<?php echo e($proveedor->documento); ?>)
                                        </option>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        $('#buscarProducto').select2({
            ...
            allowClear: true,
            ajax: {
                url: '<?php echo e(route('compras.buscar-productos')); ?>',
                dataType: 'json',
                delay: 300,
        ...
        document.getElementById('formCompra').addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route('compras.store')); ?>', {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        setTimeout(() => {
                            window.location.href = '<?php echo e(route('compras.index')); ?>';
                        }, 1500);
                    } else {
                        Toastify({
        ...
        document.getElementById('formNuevoProveedor').addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route('proveedores.store')); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\master\resources\views/compras/create.blade.php ENDPATH**/ ?>