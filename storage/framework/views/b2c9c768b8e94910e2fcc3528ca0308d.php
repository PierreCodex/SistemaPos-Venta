            ...
            <div class="card">
                <div class="card-header d-flex align-items-center flex-wrap gap-2">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('marcas.crear')): ?>
                        ...
                        <table id="tablaMarcas" class="table nowrap align-middle mb-0" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $marcas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $marca): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr data-id="<?php echo e($marca->id); ?>">
                                        <td><strong><?php echo e($marca->codigo); ?></strong></td>
                                        <td>
                                            <h5><span class="badge bg-primary"><?php echo e($marca->nombre ?? '-'); ?></span></h5>
                                        </td>
                                        <td>
                                            <?php if($marca->descripcion): ?>
                                                <i
                                                    class="bx bx-comment-dots me-1"></i><?php echo e(Str::limit($marca->descripcion, 40)); ?>

                                            <?php else: ?>
                                                -
                                            <?php endif; ?>
                                        </td>
                                        <td id="estado-badge-<?php echo e($marca->id); ?>">
                                            <?php if($marca->estado): ?>
                                        ...
                                        <td class="no-exportar">
                                            <div class="d-flex gap-1">
                                                <button type="button" class="btn btn-sm btn-info"
                                                    onclick="verMarca(<?php echo e($marca->id); ?>)" title="Ver">
                                                    <i class="ri-eye-line"></i>
                                                </button>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('marcas.editar')): ?>
                                                    <button type="button" class="btn btn-sm btn-warning"
                                                        onclick="editarMarca(<?php echo e($marca->id); ?>)" title="Editar">
                                                        <i class="ri-pencil-line"></i>
                                                    </button>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('marcas.eliminar')): ?>
                                                    <button type="button" class="btn btn-sm btn-danger"
                                                        onclick="eliminarMarca(<?php echo e($marca->id); ?>, '<?php echo e($marca->nombre); ?>')"
                                                        title="Eliminar">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('marcas.editar')): ?>
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="toggle-estado-<?php echo e($marca->id); ?>"
                                                        <?php echo e($marca->estado ? 'checked' : ''); ?>

                                                        onchange="toggleEstado(<?php echo e($marca->id); ?>)">
                                                </div>
                                            <?php else: ?>
                                                <span
                                                    class="badge <?php echo e($marca->estado ? 'bg-success' : 'bg-danger'); ?>"><?php echo e($marca->estado ? 'On' : 'Off'); ?></span>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
    ...
    <div class="modal fade" id="modalMarca" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="formMarca" method="POST" action="<?php echo e(route('marcas.store')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        window.MARCAS_CONFIG = {
            ...
            routes: {
                store: "<?php echo e(route('marcas.store')); ?>"
            },
    ...
    <script src="<?php echo e(URL::asset('js/modules/marcas/index.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\master\resources\views/marcas/index.blade.php ENDPATH**/ ?>