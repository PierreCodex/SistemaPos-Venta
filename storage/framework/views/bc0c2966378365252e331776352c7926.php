...
<?php $__env->startSection('content'); ?>
                ...
                <form id="formFiltros" class="row g-3 align-items-end">
                    <div class="col-md-3 text-uppercase">
                        ...
                        <input type="text" class="form-control flatpickr-input border-light" id="fecha_inicio"
                            value="<?php echo e($fechaInicio); ?>" placeholder="dd-mm-aaaa">
                    </div>
                    <div class="col-md-3 text-uppercase">
                        ...
                        <input type="text" class="form-control flatpickr-input border-light" id="fecha_fin"
                            value="<?php echo e($fechaFin); ?>" placeholder="dd-mm-aaaa">
                    </div>
                    <div class="col-md-2">
    ...
    <div class="row mb-3">
        <div class="col-md-6 text-uppercase">
            ...
            <span class="text-muted fs-13">Mostrando: <span class="fw-bold"><?php echo e($pagos->count()); ?></span> registros</span>
            <span class="mx-2 text-muted">|</span>
            <span class="text-muted fs-13">Total Recaudado: <span class="fw-bold text-success">S/
                    <?php echo e(number_format($totalRecaudado, 2)); ?></span></span>
        </div>
        <div class="col-md-6 text-end">
            <a href="<?php echo e(route('ventas-credito.index')); ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                    <h6 class="fs-13 mb-0"><?php echo e($pago->venta->comprobante); ?></h6>
                                                    <small
                                                        class="text-muted"><?php echo e($pago->venta->serie); ?>-<?php echo e(str_pad($pago->venta->numero, 8, '0', STR_PAD_LEFT)); ?></small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="fw-medium"><?php echo e($pago->venta->nombre_cliente); ?></span>
                                            </div>
                                        </td>
                                        <td>
                                            <?php
                                            ...
                                            <span class="badge bg-light text-dark border border-light">
                                                <i class="<?php echo e($metodoIcon); ?> me-1 align-middle"></i>
                                        ...
                                        <td class="text-end">
                                            <span class="text-success fw-bold fs-14">S/
                                                <?php echo e(number_format($pago->monto, 2)); ?></span>
                                        </td>
                                        <td><?php echo e($pago->numero_operacion ?: '-'); ?></td>
                                        <td class="text-center">
                                            <?php if($pago->observaciones): ?>
                                                <i class="ri-chat-1-line text-muted fs-16 cursor-pointer"
                                                    data-bs-toggle="tooltip" title="<?php echo e($pago->observaciones); ?>"></i>
                                            <?php else: ?>
                                                -
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <?php echo e($pago->user->name ?? 'Sistema'); ?>
                                        ...
                                        <td>
                                            <div>
                                                ...
                                                <?php echo e($pago->fecha_pago->format('d/m/Y')); ?>

                                            </div>
                                            <div class="text-muted fs-11">
                                                <i class="ri-time-line me-1"></i> <?php echo e($pago->fecha_pago->format('H:i:s')); ?>

                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <button class="btn btn-soft-danger btn-icon btn-sm"
                                                onclick="anularPago(<?php echo e($pago->id); ?>)">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\master\resources\views/ventas_credito/historial.blade.php ENDPATH**/ ?>