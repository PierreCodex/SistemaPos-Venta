...
<?php $__env->startSection('script'); ?>
    <script>
        const ROUTES = {
            listRoles: '<?php echo e(route('roles.api.list')); ?>',
            storeRole: '<?php echo e(route('roles.api.store')); ?>',
            updateRole: '<?php echo e(route('roles.api.update', ':id')); ?>',
            destroyRole: '<?php echo e(route('roles.api.destroy', ':id')); ?>',
            rolePermissions: '<?php echo e(route('roles.api.permissions', ':id')); ?>',
            listPermissions: '<?php echo e(route('roles.api.permissions.list')); ?>',
            storePermission: '<?php echo e(route('roles.api.permissions.store')); ?>'
        };

        const PERMISOS_ROLES = {
            canEdit: <?php echo e(auth()->user()->can('roles.editar') ? 'true' : 'false'); ?>,
            canDelete: <?php echo e(auth()->user()->can('roles.eliminar') ? 'true' : 'false'); ?>,
            canAssign: <?php echo e(auth()->user()->can('roles.asignar') ? 'true' : 'false'); ?>,
            canCreate: <?php echo e(auth()->user()->can('roles.crear') ? 'true' : 'false'); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\master\resources\views/roles/index.blade.php ENDPATH**/ ?>