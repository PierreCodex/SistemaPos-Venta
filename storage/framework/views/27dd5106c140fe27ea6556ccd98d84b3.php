            ...
            <div class="card">
                <div class="card-header d-flex align-items-center flex-wrap gap-2">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('categorias-globales.exportar')): ?>
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('categorias-globales.crear')): ?>
                                    ...
                                    <tr data-id="<?php echo e($categoria->id); ?>">
                                        ...
                                        <td class="no-exportar">
                                            <div class="d-flex gap-1">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('categorias-globales.editar')): ?>
                                                    <button type="button" class="btn btn-sm btn-warning"
                                                        onclick="editarCategoria(<?php echo e($categoria->id); ?>)" title="Editar">
                                                        <i class="ri-pencil-line"></i>
                                                    </button>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('categorias-globales.eliminar')): ?>
