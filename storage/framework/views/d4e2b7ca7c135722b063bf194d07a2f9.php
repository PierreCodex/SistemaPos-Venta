...
<?php $__env->startSection('content'); ?>
    ...
    <?php if($categoriasGlobales->isEmpty()): ?>
        <div class="alert alert-warning">
            <i class="ri-alert-line me-2"></i>
            <strong>Atención:</strong> Primero debes crear
            <a href="<?php echo e(route('categorias-globales.index')); ?>" class="alert-link">Categorías Globales</a>
            antes de poder agregar subcategorías.
        </div>
    <?php endif; ?>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1">Lista de Categorías</h5>
                    <div class="d-flex flex-shrink-0 gap-2">
                        <button type="button" id="btnExportarPDF" class="btn btn-soft-danger waves-effect waves-light"><i
                                class="las la-file-pdf fs-3"></i><span>PDF</span></button>
                        <!-- Buttons Group -->
                        <button type="button" id="btnExportarExcel"
                            class="btn btn-soft-success waves-effect waves-light"><i
                                class="las la-file-excel fs-3"></i><span>Excel</span></button>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('categorias.crear')): ?>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#modalCategoria" onclick="limpiarFormulario()"
                                <?php echo e($categoriasGlobales->isEmpty() ? 'disabled' : ''); ?>>
                ...
                <div class="card-body">
                    <table id="tablaCategorias" class="table nowrap align-middle" style="width:100%">
                                ...
                                <tr data-id="<?php echo e($categoria->id); ?>">
                                    <td>
                                        <h5><span class="badge badge-label bg-primary"><i
                                                    class="mdi mdi-circle-medium"></i><?php echo e($categoria->categoriaGlobal->nombre ?? '-'); ?></span>
                                        </h5>
                                    </td>
                                    <td><strong><?php echo e($categoria->nombre); ?></strong></td>
                                    <td><?php echo e(Str::limit($categoria->descripcion, 40) ?? '-'); ?></td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <button type="button" class="btn btn-sm btn-info"
                                                onclick="verCategoria(<?php echo e($categoria->id); ?>)" title="Ver">
            ...
            <div class="modal-content">
                ...
                <form id="formCategoria" method="POST" action="<?php echo e(route('categorias.store')); ?>">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="categoria_global_id" class="form-label">
                                Categoría Global <span class="text-danger">*</span>
                            </label>
                            <select
                                class="form-select js-example-basic-single <?php $__errorArgs = ['categoria_global_id'];
...
unset($__errorArgs, $__bag); ?>"
                                id="categoria_global_id" name="categoria_global_id" required>
                                <option value="">-- Seleccionar --</option>
                                <?php $__currentLoopData = $categoriasGlobales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $global): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($global->id); ?>"
                                        <?php echo e(old('categoria_global_id') == $global->id ? 'selected' : ''); ?>>
                                        <?php echo e($global->nombre); ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="mt-3">¿Eliminar la categoría:</p>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        window.CATEGORIAS_CONFIG = {
            ...
            categoriasGlobales: <?php echo json_encode($categoriasGlobales, 15, 512) ?>,
            routes: {
                store: "<?php echo e(route('categorias.store')); ?>"
            },
    ...
    <script src="<?php echo e(URL::asset('js/modules/categorias/index.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\master\resources\views/categorias/index.blade.php ENDPATH**/ ?>