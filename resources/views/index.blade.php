                        ...
                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted mb-0">
                                    {{ $esAdmin ? 'Aquí tienes un resumen detallado de las operaciones de hoy.' : 'Resumen de tus operaciones de hoy.' }}
                                </p>
                            </div>
                            <div class="mt-3 mt-lg-0">
                                <div class="row g-3 mb-0 align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <a href="{{ route('ventas.create') }}" class="btn btn-soft-success shadow-none"><i
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <p class="text-uppercase fw-bold text-white-50 text-truncate mb-0">
                                            {{ $esAdmin ? 'Ventas Hoy' : 'Mis Ventas Hoy' }}</p>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <h5 class="text-white fs-14 mb-0">
                                            <i class="ri-arrow-right-up-line fs-13 align-middle"></i>
                                            +{{ $estadisticas['cantidad_ventas_hoy'] }} vtas
                                        </h5>
                                    </div>
                                </div>
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4 text-white">S/ <span
                                                class="counter-value"
                                                data-target="{{ $estadisticas['ventas_hoy'] }}">0</span></h4>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <p class="text-uppercase fw-bold text-muted text-truncate mb-0">
                                            {{ $esAdmin ? 'Ventas este Mes' : 'Mis Ventas del Mes' }}</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">S/ <span class="counter-value"
                                                data-target="{{ $estadisticas['ventas_mes'] }}">0</span></h4>
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                    data-target="{{ $estadisticas['productos_bajo_stock'] }}">0</span>
                                                Prod.
                                            </h4>
                                            <a href="{{ url('inventario/kardex') }}"
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                    data-target="{{ $estadisticas['clientes_nuevos'] }}">0</span></h4>
                                ...
                                <div class="flex-shrink-0">
                                    <div class="dropdown card-header-dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="{{ route('ventas.index') }}">Ver historial</a>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- end card header -->
                        ...
                        <div class="card card-height-100">
                            ...
                            <div class="card-body">
                                <div class="px-2 py-0">
                                    ...
                                    @endphp
                                    @foreach ($metodosPago->take(5) as $metodo)
                                        @php
                                            $porcentaje =
                                        ...
                                        @endphp
                                        <div class="mb-4">
                                            <p class="mb-1 text-muted fw-medium">{{ $metodo->metodo_pago }} <span
                                                    class="float-end text-dark">{{ number_format($porcentaje, 0) }}%</span>
                                            </p>
                                            <div class="progress mt-2" style="height: 7px;">
                                                <div class="progress-bar progress-bar-striped progress-bar-animated {{ $claseColor }}"
                                                    ...
                                                    <tr>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <h5 class="fs-13 my-1 fw-bold text-dark">
                                                                        {{ $item->producto->nombre }}</h5>
                                                                    <span
                                                                        class="text-muted fs-11">{{ $item->producto->categoria->nombre ?? 'Sin categoría' }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="fs-13">S/
                                                            {{ number_format($item->producto->precio_venta, 2) }}</td>
                                                        <td class="text-center">
                                                            <span
                                                                class="badge bg-light text-dark border">{{ number_format($item->total_cantidad, 0) }}
                                                                uds.</span>
                                                        </td>
                                                        <td>
                                                            @if ($item->producto->stock <= $item->producto->stock_minimo)
                                                                <span
                                                                    class="badge bg-danger text-white px-2 shadow-sm">Bajo:
                                                                    {{ $item->producto->stock }}</span>
                                                            @else
                                                                <span
                                                        ...
                                                        <td>
                                                            <h5 class="fs-13 my-1 fw-bold text-primary">S/
                                                                {{ number_format($item->total_monto, 2) }}</h5>
                                                        </td>
                                                    </tr>
                                                @endif
                                            @endforeach
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-xs flex-shrink-0 me-3">
                                                                <span
                                                                    ...
                                                                    {{ strtoupper(substr($ct->cliente ? $ct->cliente->nombre : ($ct->nombre_cliente_generico ?: 'C'), 0, 1)) }}
                                                                </span>
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <h5 class="fs-13 my-0 fw-bold">
                                                                    {{ $ct->cliente ? $ct->cliente->nombre : ($ct->nombre_cliente_generico ?: 'Cliente General') }}
                                                                </h5>
                                                                <span class="text-muted fs-11">
                                                                    {{ $ct->cliente ? $ct->cliente->numero_documento : 'S/D' }}
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        <span class="fw-medium text-dark">{{ $ct->total_ventas }}</span>
                                                    </td>
                                                    <td class="text-end text-primary fw-bold">S/
                                                        {{ number_format($ct->total_gastado, 2) }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table><!-- end table -->
                                            ...
                                            @foreach ($ventasRecientes as $venta)
                                                <tr>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-xs flex-shrink-0 me-2">
                                                                <span
                                                                    ...
                                                                    {{ strtoupper(substr($venta->cliente ? $venta->cliente->nombre : ($venta->nombre_cliente_generico ?: 'C'), 0, 1)) }}
                                                                </span>
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <h5 class="fs-13 my-0 fw-bold">
                                                                    {{ $venta->cliente ? $venta->cliente->nombre : ($venta->nombre_cliente_generico ?: 'Cliente General') }}
                                                                </h5>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @endphp
                                                        <span
                                                            class="badge {{ $statusClass }} text-uppercase px-2 border-0 shadow-none">{{ $venta->estado == 'COMPLETADA' ? 'PAGADO' : $venta->estado }}</span>
                                                    </td>
                                                    <td class="text-end">
                                                        <h5 class="fs-13 mb-0 fw-bold text-dark">S/
                                                            {{ number_format($venta->total, 2) }}</h5>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody><!-- end tbody -->
                                ...
                                <div class="card bg-light border-0 shadow-none mb-4">
                                    <div class="card-body p-3">
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="fs-14 mb-0 fw-bold">{{ $estadisticas['productos_bajo_stock'] }}
                                                </h6>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="fs-14 mb-0 fw-bold">{{ $estadisticas['clientes_nuevos'] }}</h6>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var options = {
                series: [{
                    name: 'Ventas Totales',
                    data: {!! json_encode($ventasSemana['montos']) !!}
                }],
                chart: {
                    height: 350,
                    type: 'area',
                ...
                xaxis: {
                    categories: {!! json_encode($ventasSemana['fechas']) !!},
                    axisBorder: {
                        show: false
                    },
                    axisTicks: {
